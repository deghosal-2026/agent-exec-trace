...
| [Part 4](wbs-v0.1.0-part4-ship.md) | M10, M11, M12, M13, M14 | Local stack, e2e Playwright, docs/OSS, LLM validation + GitHub agent integration, release validation + v0.2.0 priority items |
...
| Milestone 14 | release validation + v0.2.0 priority items |
