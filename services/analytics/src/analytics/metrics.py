...
and read-model freshness.  All counters are thread-safe via a lock so they can be
updated from the worker loop and read from a metrics endpoint concurrently.
"""
